...
1. Provide the time slots as individual time periods that are the lowest out of the time period provided. Time slots returned aren't necessarily adjacent to each other, but are in time order.
